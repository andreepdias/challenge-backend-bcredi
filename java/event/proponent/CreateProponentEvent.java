...
public class CreateProponentEvent extends ProponentEvent {
    ...
    public CreateProponentEvent(String id, String schema, String action, LocalDateTime timeStamp, String proposalId, String proponentId, String name, String age, String monthlyIncome, String isMain) {
    ...
    public void process(ProposalService proposalService) {
        ...
        proposalService.addProponent(proposalId, proponent);
    }
}
