...
public  class CreateProposalEvent extends PropostalEvent {

    private String loanValue;
    private String numberOfMonthlyInstallments;

    public CreateProposalEvent(String id, String schema, String action, LocalDateTime timeStamp, String proposalId, String loanValue, String numberOfMonthlyInstallments) {
